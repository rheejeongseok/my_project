...
/*
	...
	$('.content3 .main_left_go').css("left",wheight/30+"%");
	$('.content3 .main_right_go').css("right",wheight/30+"%");*/
    ...
    $('.content3 .main_left_go').on('click','.view_info',function(){
	    ...
	    if($('.content3 .main_left_go').css('position')=='fixed'){
    ...
    $('.content3 .main_right_go').on('click','.view_info',function(){
    	...
    	if($('.content3 .main_right_go').css('position')=='fixed'){
