...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/cafe/css/cafelist.css">
	<link rel="stylesheet" type="text/css" href="/resources/cafe/css/common.css">
	<link rel="stylesheet" type="text/css" href="/resources/cafe/css/jquery.rateyo.min.css">
	...
	<script type="text/javascript" src="/resources/cafe/js/jquery.rateyo.min.js"></script>
    					...
    					<div class="list_l">
                            <c:choose>
                                <c:when test="${list.brand == '스타벅스' }">
                                    <img src="/resources/cafe/img/starbucks.png">
                                </c:when>
                                <c:when test="${list.brand == '할리스' }">
                                    <img src="/resources/cafe/img/hollys.png">
                                </c:when>
                                <c:when test="${list.brand == '카페베네'}">
                                    <img src="/resources/cafe/img/cafebene.png">
                                </c:when>
                                <c:when test="${list.brand == '이디야' }">
                                    <img src="/resources/cafe/img/ediya.png">
                                </c:when>
                                <c:when test="${list.brand == '탐탐' }">
                                    <img src="/resources/cafe/img/tomntom.png">
                                </c:when>
                                <c:when test="${list.brand == '커피빈' }">
                                    <img src="/resources/cafe/img/coffeebean.png">
                                </c:when>
                                <c:when test="${list.brand == '개인카페' }">
                                    <img src="/resources/cafe/img/personcafe.png">
                                </c:when>
                                 <c:when test="${list.brand == '호미빙' }">
                                    <img src="/resources/cafe/img/homibing.png">
                                </c:when>
                                 <c:when test="${list.brand == '설빙' }">
                                    <img src="/resources/cafe/img/sealbing.png">
                                </c:when>
                                 <c:when test="${list.brand == '밀탑빙수' }">
                                    <img src="/resources/cafe/img/mealtop.png">
                                </c:when>
                                 <c:when test="${list.brand == '옥루몽' }">
                                    <img src="/resources/cafe/img/oclumong.png">
                                </c:when>
                                 <c:when test="${list.brand == '눈꽃빙수' }">
                                    <img src="/resources/cafe/img/iceflower.png">
                                </c:when>
                                 <c:when test="${list.brand == '개인빙수' }">
                                    <img src="/resources/cafe/img/bingsoo.png">
                                </c:when>
                                <c:when test="${list.brand == '강아지' }">
                                    <img src="/resources/cafe/img/dog.png">
                                </c:when>
                                <c:when test="${list.brand == '고양이' }">
                                    <img src="/resources/cafe/img/cat.png">
                                </c:when>
                                <c:when test="${list.brand == '새' }">
                                    <img src="/resources/cafe/img/bird.png">
                                </c:when>
                                <c:when test="${list.brand == '기타' }">
                                    <img src="/resources/cafe/img/animal.png">
                                </c:when>
                            </c:choose>
    					</div>
    					<div class="list_r">
