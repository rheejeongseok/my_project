...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/cafe/css/cafeinfo.css">
					...
					<div class="info_t">
                        ...
                        <c:choose>
                            <c:when test="${getlike == 1 }">
                                <img src="/resources/cafe/img/like.png" userno="${user.userno }" class="ok_bookmark" alt="" />
                            </c:when>
                            <c:when test="${getlike != 1 and not empty user}">
                                <img src="/resources/cafe/img/not_like.png" userno="${user.userno }" class="bookmark" alt="" />
                            </c:when>
                            <c:otherwise>
                                <img src="/resources/cafe/img/not_like.png" class="not_bookmark" alt="" />
                            </c:otherwise>
                        </c:choose>
                        </div>
    				</div>
