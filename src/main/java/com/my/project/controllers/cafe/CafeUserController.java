...
import com.my.project.services.cafe.IServiceUser;
...
public class CafeUserController {
    ...
    public String pwdmodify(Locale locale, Model model
        ...
        return "cafe/pwdmodify";
    }
	
    @RequestMapping(value = "/user/pwdmodify", method = RequestMethod.POST)
    @ResponseBody
    public int pwdmodifypost(Model model
